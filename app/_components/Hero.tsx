...
function Hero() {
  return (
    <section className="bg-black">
        ...
        <h2 className='text-white border text-center px-3 p-2 rounded-full border-white '>See What's New | <span className='text-sky-300'>AI Diagram</span></h2>
        </div>
  <div className="mx-auto h-screen max-w-screen-xl px-4 py-12 lg:flex">
    <div className="mx-auto max-w-xl text-center">
      ...
      <p className="mt-4 sm:text-xl/relaxed text-sky-200">
